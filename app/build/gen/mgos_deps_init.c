...
static const struct lib_descr {
  ...
  bool (*init)(void);
    ...
    // "demo-bundle". deps: [ "adc" "atca" "aws" "azure" "bt-service-config" "bt-service-debug" "ca-bundle" "core" "dash" "dht" "dns-sd" "esp32-touchpad" "ethernet" "gcp" "http-server" "i2c" "neopixel" "ota-http-client" "ota-http-server" "ota-shadow" "pppos" "provision" "pwm" "rpc-azure" "rpc-gatts" "rpc-loopback" "rpc-mqtt" "rpc-service-atca" "rpc-service-config" "rpc-service-fs" "rpc-service-gpio" "rpc-service-i2c" "rpc-service-ota" "rpc-service-wifi" "rpc-uart" "rpc-ws" "shadow" "sntp" "spi" "vfs-dev-spi-flash" "watson" "wifi" ]
