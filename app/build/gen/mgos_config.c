...
const struct mgos_conf_entry mgos_config_schema_[320] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 319},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "gatts", .offset = offsetof(struct mgos_config, rpc.gatts), .num_desc = 1},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "pppos", .offset = offsetof(struct mgos_config, pppos), .num_desc = 11},
  ...
  {.type = CONF_TYPE_STRING, .key = "connect_cmd", .offset = offsetof(struct mgos_config, pppos.connect_cmd)},
...
void mgos_config_set_pppos_connect_cmd(struct mgos_config *cfg, const char *val) {
  mgos_conf_set_str(&cfg->pppos.connect_cmd, val);
}
